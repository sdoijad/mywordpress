...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/naua?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://local.naua.com:8888/';
$civicrm_paths['wp.backend.base']['url'] = 'http://local.naua.com:8888/wp-admin/';
$civicrm_setting['domain']['userFrameworkResourceURL'] = 'http://local.naua.com:8888/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost/naua_civicrm?new_link=true');
  }
}
...
$civicrm_root = '/Applications/MAMP/htdocs/local.naua.com/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/local.naua.com/wp-content/uploads/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://local.naua.com:8888');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '2FroTCuE3eFMrezmrC0hkNblKNbWnZxvcZQNorAt8');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:A0qUfQGhaGOlDCkCeOAABDBV4XVCkEgwzEvgjfo0QKWVwO2ow');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:15J0oxhUwKtdKoiwnyBNg2RpZnlX7oEAyZwew5l8vltfO4PQb3Bemw');
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/local.naua.com/wp-content/uploads/civicrm/templates_c/mail.log');
// }
