...
use Civi\ActionProvider\Validation\AbstractValidator;
use CRM_ActionProvider_ExtensionUtil as E;

/**
 * Helper class to add a configuration specification on to a quick form class.
 */
class AddValidatorConfigToQuickForm {
   ...
   * @param $prefix
	 */
	public static function buildForm(\CRM_Core_Form $form, AbstractValidator $validator, $prefix=null) {
   ...
   * @param prefix
	 * @return array
	 */
	public static function setDefaultValues(AbstractValidator $validator, $data, $prefix=null) {
		$defaultValues = array();
    if (!$prefix) {
      $prefix = get_class($validator);
    }
   ...
   * @param $prefix
	 * @return array
	 */
	public static function getSubmittedConfiguration(\CRM_Core_Form $form, AbstractValidator $validator, $prefix = null) {
    if (!$prefix) {
      $prefix = get_class($validator);
    }
