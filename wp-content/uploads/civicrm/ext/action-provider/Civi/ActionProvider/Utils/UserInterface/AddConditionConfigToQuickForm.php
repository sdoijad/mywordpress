 ...
 */
class AddConditionConfigToQuickForm {
   ...
   * @param $prefix
	 */
	public static function buildForm(\CRM_Core_Form $form, AbstractCondition $condition, $prefix=null) {
   ...
   * @param prefix
	 * @return array
	 */
	public static function setDefaultValues(AbstractCondition $condition, $data, $prefix=null) {
		$defaultValues = array();
    if (!$prefix) {
      $prefix = get_class($condition);
    }
	 ...
	 * @param \CRM_Core_Form $form
	 *   The form.
	 * @param AbstractAction $condition
	 *   The action
   * @param $prefix
	 * @return array
	 */
	public static function getSubmittedConfiguration(\CRM_Core_Form $form, AbstractCondition $condition, $prefix = null) {
    if (!$prefix) {
      $prefix = get_class($condition);
    }
