...
class X_Sidebars {
  ...
  public static function get_taxonomies () {
    ...
    if ( class_exists( 'WC_API' ) ) {
      self::$taxonomies = get_terms( array(
        'category',
        'post_tag',
        'portfolio-category',
        'portfolio-tag',
    ...
    self::$taxonomies = is_wp_error( self::$taxonomies ) ? [] : self::$taxonomies;
...
function ups_print_scripts_in_footer() {
  wp_print_inline_script_tag('jQuery(document).ready(function(){ postboxes.add_postbox_toggles(pagenow); });');
}
