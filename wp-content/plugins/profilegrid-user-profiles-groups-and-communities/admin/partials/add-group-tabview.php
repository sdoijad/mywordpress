...
<?php endif; ?>  
             ...
             <div id="mailpoet" class="pg-group-tabs-panel">
                ...
                <div class="uimrow">
                  <div class="uimfield">
						<?php esc_html_e( 'Enable MailPoet:', 'profilegrid-user-profiles-groups-and-communities' ); ?>
                  </div>
                  <div class="uiminput">
                    <input name="" id="" type="checkbox"  class="pm_toggle" value="1" style="display:none;"  disabled/>
                    <label for=""></label>
                  </div>
                    <div class="uimnote"><?php esc_html_e( 'Assign ProfileGrid users to MailPoet lists with custom field mapping and options for users to manage subscriptions.', 'profilegrid-user-profiles-groups-and-communities' ); ?>         
                         </div>
                </div>
                 ...
                 <div class="uimrow"> 
                             <div class="pg-ui-info-notice pg-premium-extension-notice">
                                 <div class="pg-premium-extension-notice-wrap">
                                     <span class="pg-premium-extension-icon"> <img src="<?php echo esc_url( $path . 'images/mailpoet.png' ); ?>" class="pg-plugin-icon" alt=""></span>
                                     <div class="pg-premium-extension-text"><?php esc_html_e( 'You can unlock these options by upgrading to ProfileGrid Premium or Installation MailPoet Integration Extension.', 'profilegrid-user-profiles-groups-and-communities' ); ?>
                                         <div class="pg-premium-extensionlink-wrap"><a href="admin.php?page=pm_extensions" target="_blank" class="pg-premium-extension-link">Learn More <span class="material-icons"> navigate_next </span></a></div>
                                     </div>
                                 </div>
