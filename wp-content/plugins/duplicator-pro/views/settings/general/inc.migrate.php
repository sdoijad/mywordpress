...
if (!$is_freelancer_plus) : ?>
    ...
    <b>
        ...
        printf(
            DUP_PRO_U::__(
                "This feature is only available in Freelancer, Business or Gold licenses. For details on how to upgrade your license %s."
            ),
            '<a href="https://snapcreek.com/duplicator/docs/faqs/#faq-presale-035-q" target="_blank">' . DUP_PRO_U::__("click here") . '</a>'
        );
        ?>
    </b><br/>
